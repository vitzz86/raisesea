...
for skill in news_help news_daily news_status news_latest news_weekly news_search news_coverage news_sources news_edit news_delist raisesea-news-intelligence; do
